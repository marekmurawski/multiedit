...
<script>
    ...
    var setMEcookie = function() {
        ...
        if ($('#autosizepageparts').is(':checked')) {
            autosizepageparts = '1';
        } else {
            autosizepageparts = '0';
        }
        ...
        var theCookie = showrow1 + '|' + showrow2 + '|' + showrow3 + '|' + showrow4 + '|' + showpageparts + '|' + autosizepageparts + '|' + pagepartheight;
    ...
    $(document).ready(function() { // @todo: change counters to be initially PHP processed - faster
        ...
        if (autosizepageparts === '1')
            $('textarea.partedit').autosize();
...
//var newname = window.prompt
    ...
    $("#partheight").live('change', function() {
        $height = $(this).val();
        setMEcookie();
        $('.partedit').attr('style', "height: " + $height + "px");
    });
