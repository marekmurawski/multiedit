...
<?php if (!isset($innerOnly)): ?>
	<div class="multiedit-item" id="multipage_item-<?php echo $k->id; ?>">
<?php endif; ?>
		<div class="header">
		<div class="actions">
		...
		<table border="0">
			...
			<tr>
				...
				<td class="label"><?php echo __('Keywords'); ?></td>
				<td>
				...
				<td class="label"><?php echo __('Created'); ?></td>
				<td class="timecolumn">
			...
			<tr>
				<td class="label"><?php echo __('Breadcrumb'); ?></td>
				<td>
				...
				<td class="label"><?php echo __('Published'); ?></td>
				<td class="timecolumn">
			...
			<tr>
				<td class="label"><?php echo __('Slug'); ?></td>
				<td>
				...
				<td class="label"><?php echo __('Tags'); ?></td>
				<td>
				...
				<td class="label"><?php echo __('Valid until'); ?></td>
				<td class="timecolumn">
