...
* The settings() function in the MultieditController.php file demonstrates the
...
* Did you know you can have the controller make a visible tab (or not)? Change
    Plugin::addController('multiedit', 'Multiedit', 'administrator', false);
  to
    Plugin::addController('multiedit', 'Multiedit', 'administrator', true);
